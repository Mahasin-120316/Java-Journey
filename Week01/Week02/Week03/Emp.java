...
public class Emp {
    public static void main(String[] args) {
        ...
        double sal1 = Double.parseDouble(scanner.nextLine());
        double fixedBonus1 = Double.parseDouble(scanner.nextLine());
        ...
        double sal2 = Double.parseDouble(scanner.nextLine());
        double initialBonus2 = Double.parseDouble(scanner.nextLine());
        double bonusPercent = Double.parseDouble(scanner.nextLine());
        double extraReward = Double.parseDouble(scanner.nextLine());
